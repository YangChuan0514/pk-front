  ...
  <div class="bg-gray-100">
    ...
    <Container class="flex-col">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full lt-sm:px-4 py-4">
        ...
        >
          <Card
            class="w-full rounded-0 transition-all hover:transform-translate-y--1 hover:shadow-lg"
            :image="item.image"
            image-type="rounded"
            :title="item.title"
            border
    ...
    <Container class="flex-col">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div
          class="lt-sm:px-4 py-4 relative h-40 flex items-center justify-center transition-all cursor-pointer hover:transform-translate-y--1 hover:shadow-lg group"
          v-for="(item, index) in recommend"
          :key="index"
        >
          <div
